  ...
  return (
    <section className="relative h-[70dvh] min-h-[420px] max-h-[640px] sm:max-h-[720px] lg:h-[92dvh] lg:max-h-none w-full overflow-hidden bg-ink-deep">
      ...
      <div className="relative z-10 flex h-full flex-col">
        {/* Headline content */}
        <div className="flex flex-1 flex-col items-center justify-center px-6 text-center min-h-0">
        ...
        <div className="border-t border-paper/10 bg-ink-deep/70 backdrop-blur-sm">

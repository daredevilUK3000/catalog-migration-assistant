  ...
  return (
    <div ref={ref} className="w-full max-w-md mx-auto">
      <div className="relative pt-2">
        {/* Rail */}
        <div className="absolute left-0 right-0 top-[26px] h-[3px] bg-[var(--ink)]/10 rounded-full" />
        <div
          className="absolute left-0 top-[26px] h-[3px] bg-[var(--brass)] rounded-full transition-all duration-1000 ease-out"
          style={{
            ...
            <div key={s} className="flex flex-col items-center gap-2 w-full">
              <div
                className={`h-[26px] w-[26px] rounded-full border-2 flex items-center justify-center text-[10px] font-mono transition-all duration-500 ${
                  i <= activeIndex
                    ? "bg-[var(--brass)] border-[var(--brass)] text-[var(--ink-deep)]"
                    : "bg-white border-[var(--ink)]/15 text-[var(--ink)]/30"
                }`}
              ...
              <span
                className={`text-[10px] text-center leading-tight ${
                  i <= activeIndex ? "text-[var(--ink)]" : "text-[var(--ink)]/40"
                }`}
              >
                {s}
              </span>
